...
class ExposedMeetingRepository : MeetingRepository {
    override fun create(clubId: Uuid, date: LocalDate, assignedMemberId: Uuid?): MeetingRow = transaction {
    ...
    override fun findById(id: Uuid): MeetingRow? = transaction {
        Meetings
            .selectAll()
    ...
    override fun findByClubAndDate(clubId: Uuid, date: LocalDate): MeetingRow? = transaction {
        Meetings
            .selectAll()
    ...
    override fun listByClub(clubId: Uuid): List<MeetingRow> = transaction {
        Meetings
            .selectAll()
    ...
    override fun updateDate(id: Uuid, date: LocalDate): MeetingRow = transaction {
    ...
    override fun updateAssignedMember(id: Uuid, assignedMemberId: Uuid?): MeetingRow = transaction {
        Meetings.update({ Meetings.id eq id }) {
            it[Meetings.assignedMemberId] = assignedMemberId
        }
        findById(id)!!
    ...
    private fun toRow(row: ResultRow) = MeetingRow(
