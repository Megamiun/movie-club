...
class ExposedSeasonRepository : SeasonRepository {
    override fun create(seriesId: Uuid, number: Int, title: String?): SeasonRow =
        transaction {
    ...
    override fun findById(id: Uuid): SeasonRow? =
        transaction {
            Seasons
                .selectAll()
    ...
    override fun listBySeries(seriesId: Uuid): List<SeasonRow> =
        transaction {
            Seasons
                .selectAll()
    ...
    override fun findReview(seasonId: Uuid, memberId: Uuid): SeasonReviewRow? =
        transaction {
            MemberSeasonReviews
                .selectAll()
    ...
    override fun listReviews(seasonId: Uuid): List<SeasonReviewRow> =
        transaction {
            MemberSeasonReviews
                .selectAll()
