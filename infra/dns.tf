# <domain> (apex) -- alias straight to CloudFront (no separate IP to manage, follows CloudFront's own DNS). An
# ALIAS record (not a CNAME) is what makes this legal at the zone apex in the first place.
